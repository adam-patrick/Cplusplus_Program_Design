...
// THis program computes and outputs the total number of
// boxes of cookies sold, the total revenue, and the
// average number of boxes sold by each volunteer.
...
int main()
{
	...
	cout << "Line 28: Enter te cost of one box: ";
	cin >> costOfOneBox;
	cout << endl;
