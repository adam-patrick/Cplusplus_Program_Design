...
int main()
{
    ...
    bool lengthCodeOk;  // variable to indicate if secret code is <= 250

    ifstream incode; // input file stream variable
    ofstream outcode;// output file stream variable

    char inputFile[51];// variable to store name of input file
    char outputFile[51];// variable to store name of output file
