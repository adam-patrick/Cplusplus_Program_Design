// This example will be just different functions.
// This is not intended to be a function program.
...
void fillArray(int listr[], int listSize)
{
    for (int index = 0; index < listSize; index++)
        cin >> list[index];
}
    ...
    // are passed as parameters. The parameters listSize
