// Given the distance traveled by an object every 10 units
...
void averageSpeedOverTimeInteral(double list[], int length,
                                 double avgSpeed[]);
...
int main()
{
    ...
    averageSpeedOverTimeInteral(distanceTraveled, SIZE, averageSpeed);
